...
ListToSend = {  ####  Voltage V #######
                ...
                ####  Reactive power var	  #######
                19036: 0x4389,          # Reactive power L1 (fundamental comp.) MSB     Q1 = 247.45 var
                19037: 0x399a,          # Reactive power L1 (fundamental comp.) LSB
                19038: 0x438c,          # Reactive power L2 (fundamental comp.) MSB     Q2 = 280.3 var
                19039: 0x2666,          # Reactive power L2 (fundamental comp.) LSB
                19040: 0x4382,          # Reactive power L3 (fundamental comp.) MSB     Q3 = 260.15 var
                19041: 0x1333,          # Reactive power L3 (fundamental comp.) LSB
                19042: 0x4444,          # Qsum3=Q1+Q2+Q3 (fundamental comp.) MSB        Qsum3 = 787.9 var
                19043: 0xf99a,          # Qsum3=Q1+Q2+Q3 (fundamental comp.) LSB
...
def run_server():
    ...
    identity.ProductCode = 'UMG 604'
    identity.VendorUrl = 'http://www.janitza.com'
    identity.ProductName = 'Power Analyser'
    identity.ModelName = 'Power Analyser UMG 604'
    identity.MajorMinorRevision = '2.x'

    # ----------------------------------------------------------------------- #
    # run the server : UMG-604 use Modbsu RTU/TCP
    # ----------------------------------------------------------------------- #
    # Tcp:
